...
[![My Skills](https://skillicons.dev/icons?i=js,ts,cs,python,html,css,react,expo,electron,tailwind,nodejs,express,dotnet,mongodb,mysql,firebase,redis,aws,gcp,render,vercel,docker,githubactions,git,github,cisco)](https://skillicons.dev)
</div>
